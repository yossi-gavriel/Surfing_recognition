...
train_path = r'C:\Users\User\Desktop\SCOOL\SCOOL\thesis\surfing_sessions_scoring\model_weights_all_train_smart_augmantation_corrected\train'
test_path = r'C:\Users\User\Desktop\SCOOL\SCOOL\thesis\surfing_sessions_scoring\model_weights_all_train_smart_augmantation_corrected\test'
...
def get_data(directory):
    ...
    for file in os.listdir(directory):
        ...
        try:
            ...
            tags.append(str(int(float(re.findall(r"[-+]?(?:\d*\.\d+|\d+)", file)[0]))))
            files.append(file)
...
def get_sequence_model():
    ...
    x = keras.layers.Dense(8, activation="relu", kernel_initializer='random_normal')(x)
